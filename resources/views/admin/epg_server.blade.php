        ...
        <div class="modal-dialog modal-simple modal-center">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Confirm Delete Epg Server</h4>
                </div>
                <div class="modal-body">
                    <p>Are you sure to delete this epg server tag?</p>
                </div>
        ...
        <div class="modal-dialog modal-simple modal-center">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title">Edit Epg Server</h4>
                </div>
                <div class="modal-body">
    ...
    <div>
        <script>
            ...
            function confirmDelete() {
                $.ajax({
                    method:'post',
                    url:site_url+"/admin/epg-server/delete/"+current_tag_id,
                    success:data=>{
                        $('#delete-news-confirm-modal').modal('hide');
                        showSuccessNotify("Epg Server deleted successfully");
                        $( current_tr ).remove();
                    },
                    error:error=>{
            ...
            function confirmUpdate(){
                ...
                saveTag(updated_tag_name, current_tag_id);
            }

            function saveTag(url, id=''){
                $.ajax({
                    method:'post',
                    url:site_url+"/admin/epg-server/create",
                    dataType:'json',
                    data:{
                        url:url,
                        id:id,
